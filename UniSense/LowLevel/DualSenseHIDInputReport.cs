...
namespace UniSense.LowLevel
{
    ...
    internal struct DualSenseHIDInputReport : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "touch0", format = "VC2B", layout = "Vector2", sizeInBits = 8, displayName = "Touch 0")]
        ...
        [InputControl(name = "touch1", format = "VC2B", layout = "Vector2", sizeInBits = 8, displayName = "Touch 1")]
