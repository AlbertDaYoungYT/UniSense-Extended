...
namespace UniSense.LowLevel
{
    ...
    internal struct DualSenseHIDInputReport : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "touch0/x", parameters = "clampMin=0,clampMax=1919")]
        [InputControl(name = "touch0/y", parameters = "clampMin=0,clampMax=1079")]
        ...
        [InputControl(name = "touch1/x", parameters = "clampMin=0,clampMax=1919")]
        [InputControl(name = "touch1/y", parameters = "clampMin=0,clampMax=1079")]
