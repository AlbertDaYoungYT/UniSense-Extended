...
namespace UniSense.LowLevel
{
    ...
    internal struct DualSenseHIDInputReport : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "touch0/x", format = "SHRT", parameters = "min=0,max=1919")]
        [InputControl(name = "touch0/y", format = "SHRT", parameters = "min=0,max=1079")]
        ...
        [InputControl(name = "touch1/x", format = "SHRT", parameters = "min=0,max=1919")]
        [InputControl(name = "touch1/y", format = "SHRT", parameters = "min=0,max=1079")]
