...
namespace UniSense.LowLevel
{
    ...
    internal struct DualSenseHIDInputReport : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "touch0/x", layout = "Axis", format = "UINT", sizeInBits = 32, parameters = "clampMin=0,clampMax=1919")]
        [InputControl(name = "touch0/y", layout = "Axis", format = "UINT", sizeInBits = 32, parameters = "clampMin=0,clampMax=1079")]
        ...
        [InputControl(name = "touch1/x", layout = "Axis", format = "UINT", sizeInBits = 32, parameters = "clampMin=0,clampMax=1919")]
        [InputControl(name = "touch1/y", layout = "Axis", format = "UINT", sizeInBits = 32, parameters = "clampMin=0,clampMax=1079")]
