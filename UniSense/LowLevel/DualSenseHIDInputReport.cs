...
namespace UniSense.LowLevel
{
    ...
    internal struct DualSenseHIDInputReport : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "touch0/press", offset = 42, layout = "TouchPressControl", bit = 0)]
        ...
        [FieldOffset(43)] public byte touchPoint1Id;
        ...
        [InputControl(name = "touch1/press", offset = 52, layout = "TouchPressControl", bit = 0)]
        ...
        [FieldOffset(53)] public byte touchPoint2Id;
