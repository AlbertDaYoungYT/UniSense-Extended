...
namespace UniSense.LowLevel
{
    ...
    internal struct DualSenseHIDInputReport : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "touch0/y", offset = 1, layout = "Axis", format = "UINT", parameters = "normalize,normalizeMin=0,normalizeMax=1079")]
        ...
        [InputControl(name = "touch1/y", offset = 1, layout = "Axis", format = "UINT", parameters = "normalize,normalizeMin=0,normalizeMax=1079")]
