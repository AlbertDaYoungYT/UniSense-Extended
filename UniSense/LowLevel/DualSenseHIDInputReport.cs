...
namespace UniSense.LowLevel
{
    ...
    internal struct DualSenseHIDInputReport : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "touch0/position/x", layout = "Axis", sizeInBits = 32, parameters = "clampMin=0,clampMax=1919")]
        [InputControl(name = "touch0/position/y", layout = "Axis", sizeInBits = 32, parameters = "clampMin=0,clampMax=1079")]
