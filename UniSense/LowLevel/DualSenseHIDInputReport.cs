...
namespace UniSense.LowLevel
{
    ...
    internal struct DualSenseHIDInputReport : IInputStateTypeInfo
    {
        ...
        [InputControl(name = "touch0/x", format = "BYTE", parameters = "clampMin=0,clampMax=1919")]
        [InputControl(name = "touch0/y", format = "BYTE", parameters = "clampMin=0,clampMax=1079")]
        ...
        [InputControl(name = "touch1/x", format = "BYTE", parameters = "clampMin=0,clampMax=1919")]
        [InputControl(name = "touch1/y", format = "BYTE", parameters = "clampMin=0,clampMax=1079")]
